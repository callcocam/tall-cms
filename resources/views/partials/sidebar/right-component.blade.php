<div x-show="$store.global.isRightSidebarExpanded" @keydown.window.escape="$store.global.isRightSidebarExpanded = false">
    <div class="fixed inset-0 z-[150] bg-slate-900/60 transition-opacity duration-200"
        x-on:click="$store.global.isRightSidebarExpanded = false" x-show="$store.global.isRightSidebarExpanded"
    ...
    <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
        <div x-data="{ activeTab: 'tabHome' }"
            ...
            <div class="flex items-center justify-between py-2 px-4">
                ...
                <button x-on:click="$store.global.isRightSidebarExpanded=false"
            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mt-4 px-3">
                    ...
                    <div class="mt-3 flex space-x-3">
                        <a href="{{ url('apps/kanban') }}" class="w-12 text-center">
                        ...
                        <a href="{{ url('dashboards/crm-analytics') }}" class="w-12 text-center">
                            <div class="avatar h-10 w-10">
                        ...
                        <a href="{{ url('apps/chat') }}" class="w-12 text-center">
                            <div class="avatar h-10 w-10">
                        ...
                        <a href="{{ url('apps/filemanager') }}" class="w-12 text-center">
                            <div class="avatar h-10 w-10">
                        ...
                        <a href="{{ url('dashboards/banking-1') }}" class="w-12 text-center">
                            <div class="avatar h-10 w-10">
            ...
            <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
                <div
                    ...
                    <button x-on:click="activeTab = 'tabHome'"
                    ...
                    <button x-on:click="activeTab = 'tabActivity'"
